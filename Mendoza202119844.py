"""
Práctica 1: Diseño de controlador de un sistema de segundo orden 
...
fig1 = plt.figure();
plt.plot(t,u1,'-',color = [1, 128/255, 0], label = 'Vs(t)')
ts,PA=ctrl.forced_response(sys,t,u1,x0)
plt.plot(t,PA,'-',color = [76/255, 31/255, 122/255], label = 'Ve(t)')
...
fig2 = plt.figure();
plt.plot(t,u2,'-',color = [1, 128/255, 0], label = 'Vs(t)')
...
fig3 = plt.figure();
plt.plot(t,u3,'-',color = [1, 128/255, 0], label = 'Vs(t)')
...
fig4 = plt.figure();
plt.plot(t,u4,'-',color = [1, 128/255, 0], label = 'Vs(t)')
